  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
      ...
      <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 transition-colors">
        ...
        <span className="font-semibold px-2 py-1 bg-gray-100 dark:bg-secondary-800 text-gray-900 dark:text-white rounded transition-colors">
          #{newOrder.reference}
        </span>{' '}
        is confirmed.
      </p>
      ...
      <div className="bg-white dark:bg-secondary-800 rounded-lg shadow-sm border border-transparent dark:border-secondary-700 p-6 mb-8 text-left transition-colors">
        <h2 className="font-semibold text-lg mb-4 border-b dark:border-secondary-700 pb-2 text-gray-900 dark:text-white transition-colors">
          Order Summary
        </h2>
        <div className="space-y-2 text-gray-600 dark:text-gray-300 mb-4 transition-colors">
          <p>
            ...
            {newOrder.shipping_address.full_name}
          </p>
          <p>
            <strong className="text-gray-900 dark:text-white transition-colors">Address:</strong>{' '}
            {newOrder.shipping_address.address_line_1}, {newOrder.shipping_address.city}
          </p>
        </div>
