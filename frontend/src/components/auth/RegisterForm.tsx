  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="bg-white dark:bg-secondary-800 rounded-lg shadow-sm border border-transparent dark:border-secondary-700 p-6 transition-colors">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-6 transition-colors">
          Create Account
        </h2>
      ...
      <div className="bg-white dark:bg-secondary-800 rounded-lg shadow-sm border border-transparent dark:border-secondary-700 p-6 transition-colors">
        <div className="space-y-4">
          <Button type="submit" disabled={isSubmitting || register.isPending} className="w-full">
