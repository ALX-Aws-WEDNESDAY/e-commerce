        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Elites is your trusted marketplace for authentic premium products. We connect local
              artisans and businesses with customers across Kenya and beyond.
            </p>
            <div className="mt-4">
              <h4 className="font-medium mb-2">Contact Us</h4>
              <p className="text-gray-300 text-sm">
                Email: info@elites.africa
                <br />
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  to="/products?category=food-groceries"
                  className="text-gray-300 hover:text-white text-sm"
                >
                  Food & Groceries
                </Link>
