...
class CartAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'get_item_count', 'get_total_price', 'is_active', 'created_at']
...
class CartItemAdmin(admin.ModelAdmin):
    list_display = ['id', 'product_name', 'cart', 'quantity', 'product_price', 'get_item_total', 'created_at']
